...
export const problem = {
  ...
  "problemCode": "class ExOver\n  # Modify this class to wrap the hello method with before and after calls\n  # Do not modify the implementations of hello, before, or after methods\nend",
  "answerCode": "# The ExOver class will be defined by the test with hello, before, and after methods\n# We need to modify the hello method to call before and after\n\nmodule HelloWrapper\n  def hello\n    before\n    super\n    after\n  end\nend\n\nclass ExOver\n  prepend HelloWrapper\nend",
