...
export const problem = {
  ...
  "description_en": "Basic quiz about Ruby blocks. Learn about passing and executing blocks, and closures. (Q3)",
  ...
  "answerExplanation": "Q2と反対に、ブロックからProcオブジェクトの変換をする練習です。仮引数で&を使うとブロックからProcオブジェクトへの変換ができます。",
  "answerExplanation_en": "Opposite to Q2, this is practice for converting from block to Proc object. By using & in the parameter, you can convert from block to Proc object.",
