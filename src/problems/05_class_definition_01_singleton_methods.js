...
export const problem = {
  ...
  "description": "Rubyの特異メソッドについての問題。特定のオブジェクトにのみメソッドを定義する方法を学びます。",
  "description_en": "A problem about Ruby singleton methods. Learn how to define methods only for specific objects.",
  ...
  "problemCode": "class ExClass\nend\n\ne1 = ExClass.new\ne2 = ExClass.new\n\n# Add hello method to e2 only\n# Judgement.call(e1, e2) will be called by the test",
