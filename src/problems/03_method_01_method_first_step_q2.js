...
export const problem = {
  ...
  "answerExplanation_en": "This is a quiz to help you understand that \"executing a method creates a new method\". This kind of implementation with nested def is not usually done, but there are situations in metaprogramming where you \"dynamically create methods when executing specific processing\".",
  "answerCode": "class F2\n  def add_hi\n    def hi; end\n  end\nend\n",
