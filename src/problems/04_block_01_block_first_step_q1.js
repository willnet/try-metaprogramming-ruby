...
export const problem = {
  ...
  "answerExplanation": "yieldもしくはcallメソッドを使うメソッド実装の練習です。Railsでアプリケーションを書いているとそれほどブロックを取るメソッドを書く機会はないのですが、素振りをしておいていざというときに使えるようにしておくと役に立つ時が来るかもしれません",
  "answerExplanation_en": "This is practice for implementing methods using yield or the call method. When writing Rails applications, there aren't many opportunities to write methods that take blocks, but practicing this might come in handy when you need it.",
